import { FaTag, FaTruck, FaCheckCircle, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
...
const Shipments = ({
  ...
  navigate('/dashboard/load-request');
    ...
    if (totalPages <= maxVisiblePages) {
        ...
        // Show smart pagination for large number of pages
        if (currentPage <= 3) {
            for (let i = 1; i <= 3; i++) {
                pages.push(
                    <button 
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div className="flex items-center gap-1">
                            <button className="p-2 text-[#3B6255] hover:text-gray-700">
